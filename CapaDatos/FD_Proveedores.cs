            ...
            using (SqlConnection cConn = new SqlConnection(Conexion.cn))
            {
                ...
                try
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        {
                            Id = System.Convert.ToInt32(dr["IdProveedor"].ToString()),
                            Tipo = System.Convert.ToInt32(dr["Tipo"].ToString()),
#pragma warning disable CS8601 // Posible asignación de referencia nula
                            Descripcion = dr["Descripcion"].ToString(),
                            Dui = System.Convert.ToInt64(dr["Dui"].ToString()),
                            Nit = System.Convert.ToInt64(dr["Nit"].ToString()),
        ...
        public static bool GuardarProveedores(Proveedor datos)
        {
            ...
            using (SqlConnection cConn = new SqlConnection(Conexion.cn))
            {
                ...
                {*/
                    ...
                    QRes = System.Convert.ToBoolean(cmd.Parameters["Resultado"].Value);
